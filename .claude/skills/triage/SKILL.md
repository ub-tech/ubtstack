...
Create a Linear issue using `mcp__linear__save_issue` with the template below. Do NOT ask the user to review before creating — just create it and share the issue identifier.
...
This issue is ready for `/kickoff` with HOLD SCOPE mode.
